...
let fetch_current_price = async function(){
    ...
    let KEY = "N3ORZMIO0KCV9WVD"; // generate a random api key
    nse_code = nse_code.trim();
    const url = `https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=${nse_code}&interval=1min&apikey=${KEY}`;
    console.log(nse_code);
    ...
    let current_price = await response.json();
        ...
        KEY = "N3ORZMIO0KCV9WVD"; 
        const url2 = `https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=${nse_code}&apikey=${KEY}`;
